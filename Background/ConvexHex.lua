function HexagonBackground(HoneycombLayer,OutlineLayer,r,g,b,a,str,stg,stb,sta,strokewidth,EdgeLength)
    ...
    local t = 0 --TimeMultiplier*getTime() 
    ...
    for ii = LX,UX,EdgeLength*3 do
        for jj = LY,UY,EdgeLength*math.sqrt(3) do
            grayvar = 1
    ...
    for ii = LX+EdgeLength*1.5,UX,EdgeLength*3 do
        
        for jj = LY+EdgeLength*math.sqrt(3)/2,UY,EdgeLength*math.sqrt(3) do
...
HexagonBackground(HoneycombLayer,OutlineLayer,r,g,b,a,0.25,0.25,0.25,sta,0.25,10)
