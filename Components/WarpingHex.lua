function HexagonBackground(HoneycombLayer,OutlineLayer,r,g,b,a,str,stg,stb,sta,strokewidth,EdgeLength)
    ...
    for ii = -45,170,EdgeLength*3 do
        for jj = -45,145,EdgeLength*math.sqrt(3) do
            grayvar = 1
            ...
            addHexagon(HoneycombLayer,OutlineLayer,X1,Y1,X2,Y2,X3,Y3,X4,Y4,X5,Y5,X6,Y6,grayvar*r,grayvar*g,grayvar*b,0.2+math.abs(CX1)/rx,str,stg,stb,sta,strokewidth,EdgeLength)
        end
    end
    
    for ii = -45+EdgeLength*1.5,170,EdgeLength*3 do
        
        for jj = -45+EdgeLength*math.sqrt(3)/2,145,EdgeLength*math.sqrt(3) do
...
local rx, ry = getResolution()
local Ship = createLayer()
local HoneycombLayer = createLayer()
local OutlineLayer = createLayer()

HexagonBackground(HoneycombLayer,OutlineLayer,r,g,b,a,str,stg,stb,sta,strokewidth,6.19)
